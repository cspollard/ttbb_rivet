...
namespace Rivet {
  ...
  class MC_TTBAR_NO_NORM : public Analysis {
  public:

    /// Constructor
    DEFAULT_RIVET_ANALYSIS_CTOR(MC_TTBAR_NO_NORM);
    ...
    void finalize() {
      ...
      scale(_h_jet_1_pT, crossSection()/picobarn/sumOfWeights());
      scale(_h_jet_2_pT, crossSection()/picobarn/sumOfWeights());
      scale(_h_jet_3_pT, crossSection()/picobarn/sumOfWeights());
      scale(_h_jet_4_pT, crossSection()/picobarn/sumOfWeights());
      scale(_h_jet_HT, crossSection()/picobarn/sumOfWeights());
      scale(_h_bjet_1_pT, crossSection()/picobarn/sumOfWeights());
      scale(_h_bjet_2_pT, crossSection()/picobarn/sumOfWeights());
      scale(_h_ljet_1_pT, crossSection()/picobarn/sumOfWeights());
      scale(_h_ljet_2_pT, crossSection()/picobarn/sumOfWeights());
      scale(_h_W_mass, crossSection()/picobarn/sumOfWeights());
      scale(_h_t_mass, crossSection()/picobarn/sumOfWeights());
      scale(_h_t_mass_W_cut, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetb_1_jetb_2_dR, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetb_1_jetb_2_deta, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetb_1_jetb_2_dphi, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetb_1_jetl_1_dR, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetb_1_jetl_1_deta, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetb_1_jetl_1_dphi, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetl_1_jetl_2_dR, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetl_1_jetl_2_deta, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetl_1_jetl_2_dphi, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetb_1_W_dR, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetb_1_W_deta, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetb_1_W_dphi, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetb_1_l_dR, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetb_1_l_deta, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetb_1_l_dphi, crossSection()/picobarn/sumOfWeights());
      scale(_h_jetb_1_l_mass, crossSection()/picobarn/sumOfWeights());
  ...
  DECLARE_RIVET_PLUGIN(MC_TTBAR_NO_NORM);
