...
namespace Rivet {
  ...
  string dsdx(const string& x, const string& xunit) {
    return "\\ensuremath{\\frac{1}{\\sigma}\\frac{d\\sigma}{d" + x + "} \\frac{{1}}{" + xunit + "}}";
  }


  class MCTTBB2_NORM : public Analysis {
  public:

    DEFAULT_RIVET_ANALYSIS_CTOR(MCTTBB2_NORM);
    ...
    DECLARE_RIVET_PLUGIN(MCTTBB2_NORM);
